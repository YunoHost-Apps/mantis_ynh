...
$g_webmaster_email      = 'webmaster@__MAIN_DOMAIN__';
$g_from_email           = 'noreply@__MAIN_DOMAIN__';	 # the "From: " field in emails
$g_return_path_email    = 'admin@__MAIN_DOMAIN__';	 # the return address for bounced mail
